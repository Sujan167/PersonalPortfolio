            ...
            >
              ...
              <div className="flex flex-wrap gap-2">
                {category.pills.map((pill, index) => (
                  <span 
                    key={index} 
                    className={`${category.colorClass} dark:bg-opacity-20 text-slate-900 dark:text-slate-100 px-3 py-1 rounded-full text-sm transition-transform duration-200 hover:-translate-y-1 hover:shadow-md`}
                  >
                    {pill}
                  </span>
                ))}
